...
//	    	입력 받은 수가 5일 때 종료한다.
	    	...
	    	case 1:
	            ...
	            break;
//	    	입력 받은 choice 값이 1이면 resultMessage값에 redMessage를 저장하고,
//	    	break 가 있어 실행 후 switch 문을 종료한다.
	        case 2:
	           resultMessage = yellowMessage;
	           break;
//		    입력 받은 choice 값이 2라면 resultMessage값에 yellowMessage를 저장하고,
//		    break 가 있어 실행 후 switch 문을 종료한다.
	        case 3:
	           resultMessage = blackMessage;
	           break;
//		    입력 받은 choice 값이 3이라면 resultMessage값에 blackMessage를 저장하고,
//		    break 가 있어 실행 후 switch 문을 종료한다.
	        case 4:
	           resultMessage = whiteMessage;
	           break;
//		    입력 받은 choice 값이 4라면 resultMessage값에 whiteMessage를 저장하고,
//		    break 가 있어 실행 후 switch 문을 종료한다.
	        default:
